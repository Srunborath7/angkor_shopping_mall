...
/**
 * Generate ABA PayWay Dynamic QR code & Deep Link via backend API
 * Credentials (merchantId, apiKey, etc.) are managed securely by the backend API.
 * @param {Object} params
 * @param {string|number} [params.orderId]
 * @param {string|number} [params.orderNumber]
